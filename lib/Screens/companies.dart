  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        centerTitle: true,
        title:Text('Companies',style:GoogleFonts.lato(textStyle:TextStyle(color:kPrimaryColor,fontWeight:FontWeight.bold)))
      ),
      body:widget.Companies.length==0?Center(child: Text('No companies to show')):
      ListView.builder(
          shrinkWrap: true,
