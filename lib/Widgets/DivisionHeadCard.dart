          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(alignment:Alignment.center,child: Text(widget.item.name,textAlign:TextAlign.center,style: GoogleFonts.lato(textStyle: TextStyle(color:Colors.black,fontSize: 0.023*pHeight),),)),
                SizedBox(height:pHeight*0.01)
              ],
            ),
          ),
